...
export default class GameInstance {
  ...
  loadNPCdata(characterConf) {
    ...
    characterData.transitions = characterConf.transitions && characterConf.transitions.length ?
      characterConf.transitions : template.transitions;
  ...
  setUpSocket() {
    this.io.on('connection', (socket) => {
      ...
      this.emitter.once('snapshot', (event) => {
